    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2 col-sm-12 bg-white" id="destaque">
                ...
                <div id="info">
                    <p>
                        Da esquina para a praia, para toda a região e também para todo o
                        Brasil. El Kalango, o santo salvador do verão a 40˚, delicioso e
                        refrescante, irreverente e colorido. Em breve, em toda a parte!
                    </p>
                    <p>
                        Buscamos entregar versatilidade em suas aplicações. O logo
                        principal em forma de escudo se aplica facilmente em patterns
                        complexos ou em cores sólidas, claras ou escuras. Desenvolvemos
                        este padrão visual para que o mesmo seja identificado em todas
                        unidades franqueadas de El Kalango.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 ">
                <div class="row">
                    <div class="col-12">
                        <p>
                            Os Patterns coloridos foram desenvolvidos para lembrar as
                            escamas da pele do Calango, foram feitas duas versões com
                            cores quentes e frias, também pode ser utilizado em diversas
                            aplicações o pattern da Selva que remete o local que o açaí é
                            cultivado e extraído. O padrão pode ser aplicado em qualquer
                            peça publicitária quando for necessário, também em unidades
                            móveis do El Kalango, freezers e decoração.
                        </p>
                    </div>
                    <div class="col-12">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9 col-sm-12">
                ...
                <p>
                    A seguir alguns dos posts que foram produzidos para o instagram e
                    facebook do El Kalango.
                </p>
            </div>
        </div>
        <div class="row pt-5">
